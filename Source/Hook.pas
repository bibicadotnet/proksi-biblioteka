...
begin
  ...
  begin
    ...
    // Цикл поиска последовательности в сеции
    for i := 0 to DATASIZE - 39 do
    begin
      CopyMemory(ADDR(BUFFER), POINTER(DATAADDR), 39);                // Скопировать в буфер из памяти секции 17 байт
