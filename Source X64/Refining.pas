...
type
  ...
  TSetsockopt = function(s: TSocket; level, optname: Integer; optval: PAnsiChar; optlen: Integer): Integer; stdcall;
...
const
  ...
  SEARCHM  : array [0..11] of Byte = ($01,$01,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00);
var
  Cmp : boolean;
  I : integer;
  X : integer;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        for I := P to P + L - 1 do Name := Name + Char(LpBuf.Buf[I]);       // Считать метку из буфера
...
function Host(const LpBuf: WSABuf; var AddrPos: Cardinal): boolean;
const
...
begin
  ...
  begin
    ...
    begin
      for X := AddrPos to lpBuffers.Len - REFINELIST[I].len  - AddrPos do
        begin
